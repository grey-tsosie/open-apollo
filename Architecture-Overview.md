...
- [Register Map](Register-Map) — BAR0 register layout
- [DSP Protocol](DSP-Protocol) — DSP command ring buffer details
- [Protocol Reference](Protocol-Reference) — TCP and WebSocket protocol documentation
