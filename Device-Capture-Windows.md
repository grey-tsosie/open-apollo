...
This is how the Apollo Twin USB was brought up on Linux. It is the USB counterpart of the [macOS DTrace capture](Device-Capture-macOS) for Thunderbolt models.
...
- [USB reverse-engineering findings](USB-Apollo-Reverse-Engineering) — what the captured protocol means
- [Submitting Your Data](Submitting-Data) — how to report what you found
