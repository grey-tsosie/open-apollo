...
See the full guide: [Device Capture (macOS)](Device-Capture-macOS)
...
See the full guide: [Device Capture (Windows, USB)](Device-Capture-Windows)

### After capturing

See [Submitting Your Data](Submitting-Data) for how to review and submit your capture.
