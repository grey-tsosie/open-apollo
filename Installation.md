...
> [!WARNING]
> **Turn OFF the Apollo before installing**
>
...
Both installers write an install report and then ask whether to send it:

```
Help improve Open Apollo — send anonymous install report? [y/N]
```
...
Declining leaves the file on disk; attach it to an issue if you want help with a failed install.

---

## Next steps

- [Supported Devices](Supported-Devices) — check your Apollo model's status
- [Daemon Setup](Daemon-Setup) — configure the mixer daemon for full mixer control
