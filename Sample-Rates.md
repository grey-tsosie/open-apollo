...
The mixer daemon accepts sample rate changes through the TCP:4710 and WS:4721 control protocols, which are used by UA Console and other control clients.
