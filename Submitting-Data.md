...
- [Device Capture on macOS](Device-Capture-macOS) — how to capture data from macOS
- [Device Capture on Windows (USB)](Device-Capture-Windows) — how to capture a USB Apollo's init sequence
- [Supported Devices](Supported-Devices) — current device support status
